  ...
  return (
    <div className="max-w-7xl mx-auto px-8 md:px-12 lg:px-16 py-6">
      <div className="relative w-full flex items-center justify-center">
        <div className="flex max-w-4xl items-center rounded-2xl bg-black border-white border-8 px-6 py-4 shadow-[0_4px_6px_rgba(0,0,0,0.3)]">
          {/* Digits */}
          ...
          {/* Label */}
          <span className="ml-3 font-mono text-white text-sm">
            pins dropped.
          </span>
        </div>
      </div>
