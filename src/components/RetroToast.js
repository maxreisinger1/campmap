...
export default function RetroToast({ message, show, onClose, retroMode }) {
  ...
  return (
    <div
      className={`fixed z-50 right-8 bottom-8 px-8 py-5 rounded-lg border-2 border-black shadow-[8px_8px_0_0_rgba(0,0,0,0.8)] font-mono text-xl flex items-center gap-3 animate-toast-in max-w-md text-center ${
